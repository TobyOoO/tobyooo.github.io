...
var Track = {
    ...
    createText: function(station, positionRelative) {
        ...
        if(station["textStyle"]){
            station.textStyle.content = station.name;
            station.textStyle.point = station.position + positionRelative;
            var text = new PointText(station.textStyle);
        }else{
